Shader "Custom/VertColorHueShiftShader"
{
	Properties
	{
	...
	SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
	{
		...
		float _Property_7092B608_Out_0 = UNITY_ACCESS_INSTANCED_PROP(Props, _HueShift);
		float3 _Hue_8145F531_Out_2;
		Unity_Hue_Degrees_float((IN.VertexColor.xyz), _Property_7092B608_Out_0, _Hue_8145F531_Out_2);
		float _Property_35C3A5BD_Out_0 = UNITY_ACCESS_INSTANCED_PROP(Props, _Saturation);
		float3 _Multiply_2FAACDCE_Out_2;
		Unity_Multiply_float(_Hue_8145F531_Out_2, (_Property_35C3A5BD_Out_0.xxx), _Multiply_2FAACDCE_Out_2);
		surface.Albedo = _Multiply_2FAACDCE_Out_2;
